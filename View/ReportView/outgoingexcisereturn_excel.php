...
header("Content-disposition: attachment; filename=OutgoingExciseReport.xls");
...
echo '' . "\t" . 'Outgoing Excise Report' . "\t" ."\t".'FROM : '.$_REQUEST['todate'] 
...
$objQuery = StockStatementModel::GetExciseReturn("OUTGOING",$_REQUEST['todate'],$_REQUEST['fromdate']);
if(empty($objQuery)){
 exit;
}
