...
<title>Non Excise Stock Statement Report</title>
<script>
    function Getpdf()
    {
        window.open('non_excise_stock_pdf.php', '_blank');
    }
</script>
</head>
             ...
             <div class="col-lg-8" style="width: 100%;">
                 <div class="panel panel-default">
                    <div class="panel-heading">
                        <i class="fa fa-bar-chart-o fa-fw"></i>Non Excise Stock Statement Report
                        ...
                        <a href="non_excise_stock_excel.php" target="_blank" >
