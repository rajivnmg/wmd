...
class PDF extends FPDF
{
    ...
    { 
        ...
        { //width
            ...
            $this->Cell(100,6,wordwrap($eachResult["Item_Desc"],20,"\r\n"),0);
            $this->Cell(25,6,$eachResult["Tarrif_Heading"],0);
            $this->Cell(15,6,$eachResult["tot_nonExciseQty"],0);
...
$header=array('SNo','PartNo','Product Description','TarifHeading','Quantity','Unit');
//Data loading
//*** Load MySQL Data ***//
...
$pdf->Cell(55);
$pdf->Write(5, 'Non-Excise Stock Statement');
$pdf->Ln();
