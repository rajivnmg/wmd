...
$w=array(10,23,23,40,40,22,15,25,25,23,25);
...
$objQuery = MarginReportModel::GetMarginReportNewPDF($_REQUEST['todate'],$_REQUEST['fromdate'],$_REQUEST['principalid'],$_REQUEST['buyerid'],$_REQUEST['txtinvoicenumber'],$_REQUEST['finyear'],$_REQUEST['marketsegment']);
