    ...
    function BasicTable($data)
    {
		...
		//echo '<pre>'; print_r($eachResult); echo '</pre>';
			...
			if($eachResult['IGST_AMOUNT'] !== "Gross Total")
			{
				...
				$this->Cell(12,5,$eachResult["marketsegment"],0);
				$this->Ln();
			}
			else
			{
				...
				$this->Cell(15,5,'',0);
				$this->Cell(8,5,'',0);
				$this->Cell(22,5,$eachResult["IGST_AMOUNT"],0);
				$this->Cell(24,5,number_format((float)$eachResult["totalprice"], 2, '.', ''),0);
				$this->Cell(12,5,'',0);
				$this->Ln();
			}
...
$header=array('SN','InvoiceNo','InvoiceDate','BuyerCode','BuyerName','Principal','PartNo','Item_Desc','Qty','Unit','Price','TotalPrice','Market Segment');
//Data loading
//*** Load MySQL Data ***//
...
$w=array(6,26,22,25,20,20,22,40,15,12,18,24,12);
