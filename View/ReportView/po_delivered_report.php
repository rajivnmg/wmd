             ...
             <div class="col-lg-8" style="width: 100%;">
                   <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i> Purchase Order Delivered Report
                        </div>
                        <!-- /.panel-heading -->
                            ...
                            <div class="form-group">
                                ...
                                <div style="width:50%; float:left;">
                                    <label>
                                        ...
                                        <input type="text" id="autocomplete-ajax-buyer" style=" z-index: 2; background: transparent;width: 550px;" ng-model="PO_Reports.BuyerName" placeholder="Search By Buyer Name" class="form-control"  />
                                    </label>
                                </div>
                                <div style="width:25%; float:left;">
                                   <label><span>PO TYPE:</span>
                                   <select id="potype" name="" ng-model="PO_Reports.PoType"  class="form-control" style=" z-index: 2; background: transparent;width: 235px;">
