...
<title>Non Excise Stock Statement Report With Date and Value</title>
<script>
    function Getpdf()
    {
		...
		if (finyear != "" && tilldate != "") {
			window.open('ondate_nonexcise_stockstatement_pdf.php?finyear='+finyear+'&tilldate='+tilldate+'&st_type='+st_type, '_blank');
		}else{
    ...
    function GetExcel()
    {
		...
		if (finyear != "" && tilldate != "") {
			window.open('ondate_nonexcise_stockstatement_excel.php?finyear='+finyear+'&tilldate='+tilldate+'&st_type='+st_type, '_blank');
		}else{
		alert('Please Select date');
	}
	}
                 ...
                 <div class="col-lg-8" style="width: 100%;">
                     <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i>Non Excise Stock Statement Report With Date and Value
                            ...
                            <div>
                        <div style="width:24%; float:left;padding-top:5px;">
                                <label>
																   <span>Financial Year:</span>
									<select id="ddlfinancialyear" style="width: 250px;" >
										<?php
                            ...
                            <input type="hidden" id="txt_type"  class="form-control" style="width:120%;" value="N"></input>
