   ...
   <div class="clr"></div>
    ...
    <div style="width:100%; float:left; height:300px; overflow:scroll;">
        <table width="350%" border="1">
              <tr>
					<td width="1%"  rowspan="2" style="text-align:center;">Sr. No.</td>
					<td width="3%"  rowspan="2" style="text-align:center;"><label><span>Item Code Part No.*</span></label></td>
					<td width="15%"  rowspan="2" style="text-align:center;"><label><span>Description</span></label></td>
					<td width="3%"  rowspan="2" style="text-align:center;"><label><span>HSN Code</span></label></td>
					<td width="6%" colspan="2" style="text-align:center;"><label><span>Quantity</span></label></td>
					<td width="3%"  rowspan="2" style="text-align:center;"><label><span>Unit</span></label></td>
					<td width="3%"  rowspan="2" style="text-align:center;"><label><span>Basic Purchase Price<br />(D)</span></label></td>
					<td width="3%"  rowspan="2" style="text-align:center;"><label><span>Total</span></label></td>
					<td width="3%"  rowspan="2" style="text-align:center;"><label><span>Discount(%)</span></label></td>
					<td width="3%"  rowspan="2" style="text-align:center;"><label><span>Discounted Value</span></label></td>
					<td width="3%"  colspan="2" style="text-align:center;"><label><span>Packing</span></label></td>
					<td width="3%"  colspan="2" style="text-align:center;"><label><span>Insurance</span></label></td>
					<td width="3%"  colspan="2" style="text-align:center;"><label><span>Freight</span></label></td>
					<td width="3%"  colspan="2" style="text-align:center;"><label><span>Others</span></label></td>
					<td width="3%"  rowspan="2" style="text-align:center;"><label><span>Taxable Value</span></label></td>
					<td width="6%" colspan="2" style="text-align:center;"><label><span>CGST</span></label></td>
					<td width="6%" colspan="2" style="text-align:center;"><label><span>SGST</span></label></td>
					<td width="6%" colspan="2" style="text-align:center;"><label><span>IGST</span></label></td>
					<td width="3%"  rowspan="2" style="text-align:center;"><label><span>Batch No.</span></label></td>
					<td width="3%"  rowspan="2" style="text-align:center;"><label><span>Expiry Date</span></label></td>
					<td width="3%" 	rowspan="2" style="text-align:center;"><label><span>Landing Price per unit.</span></label></td>
					<td width="3%" 	rowspan="2" style="text-align:center;"><label><span>Total Landing Price</span></label></td>
					
				</tr>
				<tr>
					<td width="3%" style="text-align:center;"><label><span>Principal</span></label></td>
					<td width="3%" style="text-align:center;"><label><span>Supplier</span></label></td>
					<td width="3%" style="text-align:center;"><label><span>Percent</span></label></td>
					<td width="3%" style="text-align:center;"><label><span>Amt</span></label></td>
					<td width="3%" style="text-align:center;"><label><span>Percent</span></label></td>
					<td width="3%" style="text-align:center;"><label><span>Amt</span></label></td>
					<td width="3%" style="text-align:center;"><label><span>Percent</span></label></td>
					<td width="3%" style="text-align:center;"><label><span>Amt</span></label></td>
					<td width="3%" style="text-align:center;"><label><span>Percent</span></label></td>
					<td width="3%" style="text-align:center;"><label><span>Amt</span></label></td>
					<td width="3%" style="text-align:center;"><label><span>Rate</span></label></td>
					<td width="3%" style="text-align:center;"><label><span>Amt</span></label></td>
					<td width="3%" style="text-align:center;"><label><span>Rate</span></label></td>
					<td width="3%" style="text-align:center;"><label><span>Amt</span></label></td>
					<td width="3%" style="text-align:center;"><label><span>Rate</span></label></td>
				...
				<tr>
					...
					<td>
						<input type="text" id="item_discount" ng-change="getDiscountedAmt()" ng-model="incoming_invoice_excise._discount" valid-number/>
					</td>
					<td>
						<input type="text" id="item_discounted_amt" ng-model="incoming_invoice_excise._discounted_amt"  readonly/>
					</td>
					<td>
						<input type="text" id="item_packing_percent" ng-change="getPackingAmt()" ng-model="incoming_invoice_excise._packing_percent" valid-number/>
					</td>
					<td>
						<input type="text" id="item_packing_amt" ng-model="incoming_invoice_excise._packing_amt"  valid-number/>
					</td>
					<td>
						<input type="text" id="item_insurance_percent" ng-change="getInsuranceAmt()" ng-model="incoming_invoice_excise._insurance_percent" valid-number/>
					</td>
					<td>
						<input type="text" id="item_insurance_amt" ng-model="incoming_invoice_excise._insurance_amt"  valid-number/>
					</td>
					<td>
						<input type="text" id="item_freight_percent" ng-change="getFreightAmt()" ng-model="incoming_invoice_excise._freight_percent" valid-number/>
					</td>
					<td>
						<input type="text" id="item_freight_amt" ng-model="incoming_invoice_excise._freight_amt"  valid-number/>
					</td>
					<td>
						<input type="text" id="item_other_percent" ng-change="getOtherAmt()" ng-model="incoming_invoice_excise._other_percent" valid-number/>
					</td>
					<td>
						<input type="text" id="item_other_amt" ng-model="incoming_invoice_excise._other_amt"  valid-number/>
					</td>
					<td>
				...
				<tr  ng-repeat="item in incoming_invoice_excise._items">
					...
					<td><input type="text" ng-model="item._discounted_amt" /></td>
					<td><input type="text" ng-model="item._packing_percent" /></td>
					<td><input type="text" ng-model="item._packing_amt" /></td>
					<td><input type="text" ng-model="item._insurance_percent" /></td>
					<td><input type="text" ng-model="item._insurance_amt" /></td>
					<td><input type="text" ng-model="item._freight_percent" /></td>
					<td><input type="text" ng-model="item._freight_amt" /></td>
					<td><input type="text" ng-model="item._other_percent" /></td>
					<td><input type="text" ng-model="item._other_amt" /></td>
