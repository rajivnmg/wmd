           ...
           <label><span>Item Description</span></label>
             <table width="100%" border="0">
                ...
                <tr>
                    <td>&nbsp;</td>
                    <td>
                     <input type="text" name="" id="autocomplete-ajax-principal" style=" z-index: 2; background: transparent;" tabindex="5" placeholder="Type Principal Name" ng-model="Challan._principalname" />
                    ...
                    <input type="text" id="itemid" ng-model="Challan.itemid" style="display: none;"> 
                     <input type="text" name="_code_part_no_add" id="_code_part_no_add" style=" z-index: 2; background: transparent;" placeholder="Type Item Code Part"  ng-model="Challan._code_part_no_add" />
                   
                    </td>
                    <td><input type="text" ng-model="Challan.item_desc" name="item_desc" id="item_desc" readonly/></td>
                    <td><input type="text" ng-model="Challan._qty_add" name="_qty_add" id="_qty_add" is-number /></td>
