...
{    
	...
	var newLocation = "../../pdf/print_nonexcise_invoice.php?invoiceId="+invoiceId+"&printtype="+printtype;
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0"  style="color: #000;">
        <tr>
            ...
            <td class="tin_two" style="border-bottom:1px solid #2c2c2c;  padding:5px;">
                ...
                <div id="discountdetails">- Discount @ <span id="discount_percent"></span> %</div>
...
<input type="hidden" name="invoiceId" id="invoiceId"  value="<?php echo $_REQUEST['OutgoingInvoiceNonExciseNum']; ?>"/>

<div align="center" style="height:25px;">
<input type="button" name="prt" id="ipr" value="Print Current Page" style="width:150px;" onclick="printDoc('printableArea');"/>&nbsp;
&nbsp;&nbsp;<input type="button" name="prt1" id="ipr1" value="Print in MultiPage" style="width:150px;" onclick="printMultiPage();"/>&nbsp;
