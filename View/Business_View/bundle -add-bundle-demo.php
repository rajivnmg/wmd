	 ...
	 <!-- Bundle part start -->
		 <table width="100%" border="0">
            <tr>
              ...
              <td width="3%" align="center">GL Acc</td>
              <td width="6%" align="center">Description</td>
              <td width="15%" align="center">Quantity</td>
              <td width="10%" align="center">UOM</td>
              <td width="3%"><div align="center">Unit Rate INR</div></td>
              <td width="2%" align="center">Discount(%) </td>
              <td width="5%" align="center">Sale Tax (%)</td>
              <td width="5%" align="center">Net Amt INR)</td>
            ...
            <tr>              
				  ...
				  <td><input name="bqty" type="text" id="biqty" ng-model="purchaseOrder.bpo_qty"  value="filled by user" size="4" ng-change="calculateValue();"   tabindex="25"/></td>
				  <td><hidden id="unitId" ng-model="purchaseOrder.bpo_unitid"/>
				  <input type="text" name="bunit" id="biunit" ng-model="purchaseOrder.bpo_unit"  tabindex="3111"/></td>
				  <td><input name="bprice" type="text" id="biprice" ng-model="purchaseOrder.bpo_price" ng-change="calculateBundleValue();checkPrice();" tabindex="26" /></td>
				  <td><input name="bdiscount" type="text" id="bidiscount" ng-model="purchaseOrder.bpo_discount"  tabindex="27" value=""  ng-change="calculateValue(); checkDiscount();" /></td>
				
				 <td><select name="bsalestax" id="bisalestax" ng-model="purchaseOrder.bpo_saleTax" ng-change="getText3();" tabindex="28">
				 </select></td>
				 <td><input name="btotVa" type="text" id="bitotVal"  ng-model="purchaseOrder.bpo_totVal"  tabindex="29"/></td>
				 <td></td>            
        ...
        <table width="100%" border="0">
            ...
            <tr>
				  ...
				  <td><input name="item_desc" type="text" id="item_desc" ng-model="purchaseOrder.item_desc" value=""  tabindex="32"/></td>
				  <td><input name="bitemcode" type="text" id="ibitemcode" ng-model="purchaseOrder.po_buyeritemcode" tabindex="33"/></td>
				  <td><input name="qty" type="text" id="iqty" ng-model="purchaseOrder.po_qty"  value="filled by user" size="4" ng-change="calculateValue();" tabindex="34"/></td>
				  <td><hidden id="unitId" ng-model="purchaseOrder.po_unitid"/>
				  <input type="text" name="unit" id="iunit" ng-model="purchaseOrder.po_unit" tabindex="3111"/></td>
				  <td><input name="price" type="text" id="iprice" ng-model="purchaseOrder.po_price" ng-change="calculateValue();checkPrice();" tabindex="35"/></td>
				  <td><input name="totVa" type="text" id="itotVal"  ng-model="purchaseOrder.po_totVal"  tabindex="36" /></td>
				  <td><label> &nbsp;&nbsp;&nbsp;
            <input class="button" type="button" name="Add" id="iAdd" value="Add" ng-model="purchaseOrder.additem"  tabindex="38" ng-click="addItem()"/>
             ...
             <tr id="poRow" ng-repeat="item in purchaseOrder._items" >
				 <td><input type="text" ng-model="item.cPartNo"  /><input type="hidden" ng-model="item.po_codePartNo"  style="width:50px;"/></td>
				 <td><input type="text" ng-model="item.iden_mark" /></td>
				 <td><input type="text" ng-model="item.item_desc" /></td>
				 ...
				 <td><input type="text" ng-model="item.po_unit"  /><input type="hidden" ng-model="item.unit_id" /></td>
				 <td><input type="text" ng-model="item.po_price" ng-change="RowChangeEvent(item);" /></td>
				 <td><input type="text" ng-model="item.po_totVal" /></td>
