...
class="smart-green">
    <div align="center" style="width:100%;"> 
        <select id="invtypeselect" onchange="invtype()">
            ...
            <option value="DUPLICATE FOR TRANSPORTER">DUPLICATE FOR 
TRANSPORTER</option>
            <option value="COPY">COPY</option>
            <option value="QUADUPLICATE FOR ASSESSE">QUADUPLICATE FOR 
ASSESSE</option>
            <option value="TRIPLICATE FOR CENTRAL EXCISE">TRIPLICATE FOR 
CENTRAL EXCISE</option>
        </select>
    </div>
    <div align="center" id="printbtn">
<input type="button" name="prt" id="ipr" value="Print" style="width:50px;" 
onclick="printDoc('printableArea');"/>&nbsp;
<input type="button" name="cnl" id="icn" value="Cancel" 
style="width:55px;" 
onclick="location.href='view_Outgoing_Invoice_Excise.php'"/>
</div>
