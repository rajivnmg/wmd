...
<div style="width:50%; float:left;">         
      ...
      <div style="width:50%; float:left;">
		  ...
		  <div style="width:50%; float:left;">
                <label>
                    <span>Insurance Charge:</span><input type="text" name="ins_charge"   id="ins_charge" is-number  ng-model="purchaseOrder.ins_charge"  tabindex="39"  />
                </label>
          </div>
          <div style="width:50%; float:left;">
                <label>
                    <span>Other Charges:</span><input type="text" name="othc_charge" id="othc_charge" is-number ng-model="purchaseOrder.othc_charge" value="filled by user"  tabindex="40" />
                </label>
          </div>
          <div class="clr"></div>
