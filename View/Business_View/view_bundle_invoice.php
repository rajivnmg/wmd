...
<div align="center">
    <h1>Bundle Invoice Search/List<span></span></h1>
</div>
<div style="width:25%; float:left;">
<a class="button" href="<?php print SITE_URL.NEW_BUNDLE_INVOICE; ?>">New</a>
</div>
<div class="clr"></div>
<div>
...
<div align="center" style="margin-top: 10px;">
    <label>
        <a class="button" style="margin-top:20px;" onclick="SearchOutgoingBundleInvoiceExcise();">Search</a>
    </label>
</div>
<div class="clr"></div>
</div>
<div id="ShowData_Div" style=" margin-top:30px; margin-left:-30px;">
    <table class="outgoing_bundle_invoice_list" style="display: none; width:100%;"></table>
</div>
<script type='text/javascript' src='../js/Business_action_js/view_bundle_invoice.js'></script>
