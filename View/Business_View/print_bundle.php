...
<title>Print - Bundle Invoice Non-Excise</title>
...
<script type='text/javascript' src='../js/Business_action_js/print_bundle_invoice.js'></script>
...
?>
<form id="form1" ng-controller="Bundle_Controller" data-ng-init="print('<?php echo $_GET['bundle'];?>');" class="smart-green">
...
<div id="printableArea">
    <div style="width: 100%; height: 150px; border: 0px solid #000;">
        <div style="width: 68%; height: 150px; float: left;">
            <div style="height:120px;">
                <div style="width: 50%; padding-top: 60px; float: left;" class="invc_tp_one invc_runng">
                    ...
                    TIN <?php echo $CompanyInfo["TIN"]; ?></div>
                <div style="width: 50%; float: left;" align="center">
                     <span id="vat_invoice" style=" color: #000; font-size: 20px; "><u>TAX INVOICE</u></span>
                    <div id="vat_invoice2" style=" color: #000; font-size: 17px; padding-top:5px;">VALID FOR INPUT TAX</div>
        ...
        <div style="width: 32%;height: 150px; float: left; font-size: 14px;">
            ...
            <div class="invc_tp_three invc_runng">
             <?php echo wordwrap($CompanyInfo["Address"], 30, "<br />\n"); ?> 
			 <?php echo $CompanyInfo["email"]; ?> </br>
    ...
    <div >
        ...
        <td rowspan="3" class="invc_runng_one" style=" border-right: 1px solid #4a4a4a;"><span>To, <br />
            ...
            {{BuyerDetaile._bill_add1}},{{BuyerDetaile._bill_add2}}<!--,{{BuyerDetaile._location_name}}, {{BuyerDetaile._city_name}}--> </td>
                <td  class="invc_two invc_runng_one"><span>Tax Invoice No. : {{outgoing_bundle_invoice_nonexcise.oinvoice_No}}</span></td>
                <td class="invc_three invc_runng_one"><span>Date </span> : {{outgoing_bundle_invoice_nonexcise.oinv_date}}</td>
        ...
        <tr>
        <td class="invc_runng_one"><span>Through </span> : {{outgoing_bundle_invoice_nonexcise.mod_delivery_text}}</td>
    ...
    <div style="border:1px solid #000; color: #000; height:340px;">
        <div style="float: left;height:340px; width: 8%; text-align: center; font-weight: bold; font-size: 14px; border-right: 1px solid #000;">
            ...
            <div style="padding: 5px; height: 25px;font-weight: normal; font-size: 14px;" ng-repeat="bundle in outgoing_bundle_invoice_nonexcise.bundles">{{$index + 1 }}</div>
        </div>
        <div style="float: left;height:340px; width: 24%; text-align: center; font-weight: bold; font-size: 14px; border-right: 1px solid #000;">
            ...
            <div style="padding: 5px; height: 25px;font-weight: normal; font-size: 14px;" ng-repeat="bundle in outgoing_bundle_invoice_nonexcise.bundles" class="exactFit">{{bundle.ibglAcc}}</div>
        </div>
        <div style="float: left;height:340px; width: 30%; text-align: left; font-weight: bold; font-size: 14px; border-right: 1px solid #000;">
            ...
            <div style="padding: 5px; height: 25px;font-weight: normal; font-size: 14px;" ng-repeat="bundle in outgoing_bundle_invoice_nonexcise.bundles" class="exactFit">{{bundle.ibitem_desc}}<div>{{bundle.cpart}}</div></div>
        </div>
        <div style="float: left;height:340px; width: 10%; text-align: center; font-weight: bold; font-size: 14px; border-right: 1px solid #000;">
            ...
            <div style="margin-top: 7px; margin-left: 2px; height: 38px;font-weight: normal; font-size: 14px;" ng-repeat="bundle in outgoing_bundle_invoice_nonexcise.bundles">{{bundle.issue_qty}} {{bundle.unit_name}} </div>
        </div>
        <div style="float: left;height:340px; width: 12%; text-align: right; font-weight: bold; font-size: 14px; border-right: 1px solid #000;">
            ...
            <div style="padding: 5px; height: 25px;font-weight: normal; font-size: 14px;" ng-repeat="bundle in outgoing_bundle_invoice_nonexcise.bundles">{{bundle.ibpo_price}}</div>
        </div>
        <div style="float: left;height:340px; width: 15%; text-align: right; font-weight: bold; font-size: 14px; border-right: 0px solid #000;">
            ...
            <div style="padding: 5px; height: 25px;font-weight: normal; font-size: 14px;" ng-repeat="bundle in outgoing_bundle_invoice_nonexcise.bundles">{{bundle.ibpo_totVal}}</div>
        </div>
        <div class="clr"></div>
    </div>
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0"  style="color: #000;">
        ...
        <tr>
            ...
            <td class="tin_three" style=" border-right:1px solid #2c2c2c; font-weight: bold; color: #000;">{{outgoing_bundle_invoice_nonexcise.bill_value}}</td>
        </tr>
        <tr>
            <td colspan="3" class="tin_fr" style="border-bottom: 1px solid #2c2c2c; border-right:1px solid #2c2c2c; border-left:1px solid #2c2c2c; padding:5px; font-weight: bold; color: #000;">Rupees: {{outgoing_bundle_invoice_nonexcise.toatlvalueinword}} Only</td>
...
<input type="button" name="cnl" id="icn" value="Cancel" style="width:55px;" onclick="location.href='view_bundle_invoice.php'"/>
</div>
</form>
</body>
</html>