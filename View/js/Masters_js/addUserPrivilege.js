...
myApp.controller('groupPermissionController', function ($scope) {
 ...
 $scope.toggleSelection = function toggleSelection(prmName,sid) {
   ...
   $scope.init=function(USERID)
   {
   	 // alert(groupid);
   	  jQuery.ajax({
   	   	url: "../../Controller/Master_Controller/UserPrivileges_Controller.php",
            type: "POST",
   ...
   $scope.Update=function()
   {
   	 ...
   	 // alert($scope.selection);
   	   ...
   	   jQuery.ajax({
   	   	url: "../../Controller/Master_Controller/UserPrivileges_Controller.php",
            type: "POST",
            data: { TYP: "UPDATE","USERID":USERID,"PERMISSIONDATA":$scope.selection },
            success: function (jsondata) {
				...
				window.location.href="../../View/masters/UsersList.php";
				}
				else
				{
					alert("Error: Invalid Request ");
