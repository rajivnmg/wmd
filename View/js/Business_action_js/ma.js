...
managemenapproval_app.controller('ma_Controller', function ($scope) {
    ...
    $scope.giveApp = function (fp) {
		if(($scope.managementapp.mrem == null ) || ($scope.managementapp.mrem == undefined ) || ($scope.managementapp.mrem.trim() == '' ))
		{
			alert('Management Comments cannot be blank.');
		}
		//else if($scope.managementapp.asTag.trim() == '' )
		else if(($scope.managementapp.asTag == null ) || ($scope.managementapp.asTag == undefined ) || ($scope.managementapp.asTag.trim() == '' ))
		{
