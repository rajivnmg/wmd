...
schedule_app.controller('pos_Controller', function ($scope){
    ...
    $scope.addItem = function () {
       ...
       if($scope.pos.schDate==""){
    	...
    	$scope.pos._items.push({bpod_Id:$scope.pos.bpod_Id,pname:$scope.pos.pname,sch_principalId:$scope.pos.sch_principalId,cPartNo:$scope.pos.cPartNo,
    	sch_codePartNo:$scope.pos.sch_codePartNo,item_desc:$scope.pos.item_desc,bic:$scope.pos.bic,sch_rqty:$scope.pos.sch_rqty,schDate:$scope.pos.schDate,
    	sch_dqty:$scope.pos.sch_dqty,sch_ed_applicability:$scope.pos.sch_ed_applicability});
