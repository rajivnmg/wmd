...
Outgoing_Invoice_Excise_App.controller('Outgoing_Invoice_Excise_Controller', ['$scope', '$http', function Outgoing_Invoice_Excise_Controller($scope, $http) {
    ...
    $scope.BillCalculation = function () {
        ...
        var pf_chrg = 0.00;
        var incidental_chrg = 0.00;
        var ins_charge = 0.00;
        var othc_charge = 0.00;
        ...
        //$scope.outgoing_invoice_excise.total_ed = 0;
        $scope.outgoing_invoice_excise.bill_value = 0;
        //$scope.outgoing_invoice_excise.total_discount = 0;
        //$scope.outgoing_invoice_excise.total_saleTax = 0;
        //var ed_amt = 0.00, edu_amt = 0.00, cvd_amt = 0.00, hedu_amt = 0.00;
       ...
       // var F_tag=$("#freightTag").val();
        while (k < $scope.outgoing_invoice_excise._items.length) {
          ...
          //  cvd_amt = cvd_amt + parseFloat($scope.outgoing_invoice_excise._items[k]["cvd_amt"]);
            basic_amount = parseFloat(basic_amount) + parseFloat($scope.outgoing_invoice_excise._items[k]["tot_price"]);
            k++
        }
        PayAmount =  parseFloat(freight_amount) + parseFloat(pf_chrg) + parseFloat(incidental_chrg) + parseFloat(ins_charge) + parseFloat(othc_charge) + parseFloat(basic_amount);
        $scope.outgoing_invoice_excise.bill_value = parseFloat(PayAmount).toFixed(2);
