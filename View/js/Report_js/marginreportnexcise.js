...
function Loadmarginreport() {
    ...
    $(".marginreport").flexigrid({
        ...
        colModel: [{ display: 'S. No.', name: 'SN', width: 50, sortable: false, align: 'center' },
                ...
                { display: 'CodePart', name: 'Item_Code_Partno', width: 100, sortable: false, align: 'left' },
...
function Search(type,value) {
    ...
    var path = URL + '?TYP=MARGINREPORTNONExcise'+'&todate='+Todate+'&fromdate='+Fromdate+'&principalid='+principalid+'&buyerid='+ buyerid+'&txtinvoicenumber='+txtinvoicenumber+"&finyear="+finyear+"&marketsegment="+marketsegment;
    if (Fromdate != "" && Todate != "") {
...
$('#txtinvoicenumber').on('keypress', function (e) { 
    ...
    if (code == 13) {
        ...
        if ($('#txtinvoicenumber').val() != "") {
            var path = URL + '?TYP=MARGINREPORTNONExcise'+'&todate='+Todate+'&fromdate='+Fromdate+'&tag=INVOICENO&value=' + $('#txtinvoicenumber').val();
            $(".marginreport").flexOptions({ url: path });
            $(".marginreport").flexReload();
        }
    }
...
function Getpdf() {
    ...
    var txtinvoicenumber = $('#txtinvoicenumber').val();
    if (Fromdate != "" && Todate != "") {
		window.open('marginreportNonExcise_pdf.php?todate='+Todate+'&fromdate='+Fromdate+'&principalid='+principalid+'&buyerid='+ buyerid+'&txtinvoicenumber='+txtinvoicenumber+"&finyear="+finyear+"&marketsegment="+marketsegment,'_blank');
	}else {
        alert("Please select date");
    }
}
function Getexcel() {
   var Fromdate = $("#txtdatefrom").val();
    ...
    var txtinvoicenumber = $('#txtinvoicenumber').val();
    if (Fromdate != "" && Todate != "") {
		window.open('marginreportnonexcise_excel.php?todate='+Todate+'&fromdate='+Fromdate+'&principalid='+principalid+'&buyerid='+ buyerid+'&txtinvoicenumber='+txtinvoicenumber+"&finyear="+finyear+"&marketsegment="+marketsegment,'_blank');
    }else {
        alert("Please select date");
    }
}
