...
function LoadOutgoingInvoiceExcise() {
    ...
    $(".outgoing_invoice_excise_list").flexigrid({
        ...
        colModel: [{ display: 'S. No.', name: 'SN', width: 80, sortable: false, align: 'center' },
				...
				{ display: 'Principal Name', name: 'PRINCIPAL_NAME', width: 250, sortable: false, align: 'left' },
				...
				{ display: 'DISCOUNT', name: 'DISCOUNT', width: 110, sortable: false, align: 'left' },
				{ display: 'TAXABLE AMOUNT', name: 'TAXABLE_AMOUNT', width: 80, sortable: false, align: 'left' },
				{ display: 'CGST_AMOUNT', name: 'CGST_AMOUNT', width: 110, sortable: false, align: 'left' },
				{ display: 'SGST_AMOUNT', name: 'SGST_AMOUNT', width: 110, sortable: false, align: 'left' },
				{ display: 'IGST_AMOUNT', name: 'IGST_AMOUNT', width: 110, sortable: false, align: 'left' },
                { display: 'Total Value', name: 'totalprice', width: 110, sortable: false, align: 'left'},
				{ display: 'FREIGHT AMOUNT', name: 'FREIGHT_AMOUNT', width: 110, sortable: false, align: 'left'},
				{ display: 'P_F AMOUNT', name: 'P_F_AMOUNT', width: 110, sortable: false, align: 'left'},
				{ display: 'INCIDENTAL AMOUNT', name: 'INCIDENTAL_AMOUNT', width: 110, sortable: false, align: 'left'},
				{ display: 'INSURANCE AMOUNT', name: 'INSURANCE_AMOUNT', width: 110, sortable: false, align: 'left'},
				{ display: 'OTHER AMOUNT', name: 'OTHER_AMOUNT', width: 110, sortable: false, align: 'left'},
				{ display: 'Invoice Value', name: 'INVOICE_VALUE', width: 110, sortable: false, align: 'left'},
