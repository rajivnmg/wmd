...
<div style="width:64%; float:left;">
    <label>
        ...
        <input type="text" id="autocomplete-ajax-buyer" style=" z-index: 2; background: transparent;" placeholder="Search By Buyer Name" onKeyPress="loadBuyerByName(this.value);"/>
    </label>
</div>
<div style="width:30%; float:left;">
    <label>
        <span>Buyer Level:</span>
        <select name="select" id="byrlvl"  onChange="SearchBuyer('Lavel',this.value,0);">
...
echo "<select name='state' id='state' onChange='showCity(this.value,0);'> <option value='0'> Select State</option>";
...
<div style="width:30%; float:left;margin-left:3%;">
    <label>
        <span>City Name:</span>            
        <select name="city" id="city" onChange="showLocation(this.value,0);"><option value="0">Select City</option></select>
    </label>
</div>
<div style="width:30%; float:left;margin-left:2%;">
        <label>
            <span>Location:</span><select name="location" id="location" onChange="SearchBuyer('Location',this.value,0);"><option value="0">Select Location</option></select>
        </label>
    </div>
