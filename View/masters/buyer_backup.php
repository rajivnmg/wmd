...
<div align="center"><h1>Buyer Entry Form</h1></div>
    ...
    <div style="width:25%; float:left;">
        <label>
            ...
            <input type="text" name="buyer_nm28" id="mobile" ng-model="buyer._mobile" placeholder="Mobile No" tabindex="11" valid-number/>
        </label>
    ...
    <div style="width:25%; float:left;">
        <label>
            ...
            <input type="text" name="buyer_nm27" id="phone"  ng-model="buyer._phone" placeholder="Phone No" tabindex="12" required/>
        </label>
    </div>
    <div style="width:25%; float:left;">
        <label>
    ...
    <div align="center"><strong>Shipping Address 1</strong></div>
      ...
      echo("</select>");
        ...
        <div style="width:50%; float:left;">
            <label>
                <span>Phone No:</span>
                <input type="text" name="ship1_phon" id="ship1_phon"  ng-model="buyer._shipping_phone" placeholder="Phone No" tabindex="34" required valid-number/>
            </label>
        </div>
        <div class="clr"></div>
        <div style="width:50%; float:left;">
            <label>
                <span>Mobile No:</span>
                <input type="text" name="ship1_mobile" id="ship1_mobile" ng-model="buyer._shipping_mobile" placeholder="Mobile No" tabindex="35" valid-number/>
            </label>
        </div>
        <div style="width:50%; float:left;">
            <label>
    ...
    <div align="center"><strong>Shipping Address 2</strong></div>
        ...
        <div style="width:50%; float:left;">
            <label>
                <span>Phone No:</span>
                <input type="text" name="ship2_phon" id="ship2_phon" ng-model="buyer.shippingphone2" placeholder="Phone No" tabindex="45" valid-number/>
            </label>
        </div>
        <div class="clr"></div>
        <div style="width:50%; float:left;">
            <label>
                <span>Mobile No:</span>
                <input type="text" name="ship2_mobile" id="ship2_mobile" ng-model="buyer.shippingmobile2" placeholder="Mobile No" tabindex="46" valid-number/>
            </label>
        </div>
        <div style="width:50%; float:left;">
            <label>
