...
class SalseReportModel
{
	...
	public static function GetPurchaseReportNew($todate,$fromdate,$marketseg,$invoicenumber,$pid,$itemid){		
        ...
        if(mysql_num_rows($result) > 0){		
			...
			//$data[$counter] = array('SN'=>'','invoice_No'=>'','inv_date'=>'','Principal_Supplier_Name'=>'','Item_Code_Partno'=>'','Item_Desc'=>'','qty'=>'','unitrate'=>'','basic_value'=>'Total : ','bill_value'=>$total_val);
			$data_1[$counter] = array('SN'=>'','invoice_No'=>'','inv_date'=>'','Principal_Supplier_Name'=>'','Item_Code_Partno'=>'','Item_Desc'=>'','qty'=>'','unitrate'=>'','basic_value'=>'Total : ','bill_value'=>$total_val, 'CGST_AMOUNT'=>'', 'SGST_AMOUNT'=>'', 'IGST_AMOUNT'=>'', 'PACKING_AMOUNT'=>'', 'INSURANCE_AMOUNT'=>'', 'FREIGHT_AMOUNT'=>'', 'OTHER_AMOUNT'=>'', 'DISCOUNT'=>'');
		}   
		return $data_1;
    }
